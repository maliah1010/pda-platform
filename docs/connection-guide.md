...
Restart the application. You should see PDA Platform listed in the MCP tools panel with 41 tools available.
...
4. The 41 tools will appear in the conversation
...
The 41 tools are now available in your Claude Code session.
...
Once connected, your AI assistant has access to 41 tools across five areas:
...
| **Assurance** | 20 | Track assumptions and drift, check artefact currency, analyse review findings, monitor confidence, schedule reviews, log overrides, search lessons learned, measure overhead, run workflows, classify programme complexity |
